...
For a more advanced setup, there are more DNS records you should watch out for in the [Mailcow documentation](https://docs.mailcow.email/prerequisite/prerequisite-dns/).
...
> When you run `./generate_config.sh`, you need the [latest version of docker compose v2](https://docs.mailcow.email/i_u_m/i_u_m_install/#docker-compose). You can use `docker compose version` to get your version and check if you need to [upgrade to version 2](https://docs.docker.com/compose/compose-file/compose-versioning/#version-1-to-2x).
