...
> Image suggestion: screenshot of Site Health showing the updated values.
>
...
> Image suggestion: screenshot of the relevant phpinfo lines (then delete the file).
>
...
Signed-off-by: Declan Emery <YOUR@EMAILPROVIDER.TLD>
