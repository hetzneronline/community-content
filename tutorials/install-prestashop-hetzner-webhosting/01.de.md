...
path: "/tutorials/install-prestashop-hetzner-webhosting/01.de.md"
...
### Schritt 3 - ee Installations-Assistent
...
* Klicke auf `Weiter` und du landest auf der Lienzvereinbarung, setze hier das Häkchen bei `Ich akzeptiere die obenstehenden AGB`
...
* Klicke auf `Weiter` um die EInrichtung von Prestashop abzuschließen. Der Assistent erstellt nun die nötigen Tabellen in der Datenbank, installiert alle benötigten Moduel sowie Plugins und nimmt noch abschließende Konfigurationen vor.
...
* Per `SSH` funktioniert das folgnedermaßen, beachte bitte jedoch dabei, dass Du diesen command nur im Installationsverzeichnis von Prestashop ausführst und richtig kopierst, ansonsten kann es sein, dass Du andere Verzeichnisse mit dem gleichen Namen oder Dein gesamtes Webverzeichnis löscht. Wir übernehmen keine Haftung für gelöschte Daten!
