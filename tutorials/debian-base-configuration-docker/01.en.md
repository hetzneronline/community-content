...
Since Debian does not provide a recent version of Docker in the official repositories, the repositories of Docker are required to download via the package manager. The [Official Documentation](https://docs.docker.com/engine/install/debian/) describes how to include them.
