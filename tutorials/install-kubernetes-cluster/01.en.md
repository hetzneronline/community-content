...
* 2 Hetzner cloud CX33 servers
* 1 IPv4 Floating IP address
* 1 IPv6 Floating IP address (optional)

The CX23 server will be the master node and the CX33 servers the worker nodes. The Floating IP address(es) will be used for LoadBalancer services.
