...
Prices for the licenses can be found in the [Price List Additional Products Wiki page](https://wiki.hetzner.de/index.php/Preisliste_Zusatzprodukte#Sonstiges).
