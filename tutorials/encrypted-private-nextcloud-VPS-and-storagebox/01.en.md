...
Now you can proceed with setting up your VPS - I usually follow the DigitalOcean guide for a basic setup: https://www.digitalocean.com/community/tutorials/initial-server-setup-with-debian-11
...
If you now go to your domain registrat for your own domain, you can adjust the A and the AAAA record for your (sub)domain for your ipv4 and ipv6 addresses respectively.
...
Then we create a systemd .mount unit:
...
Where=/mnt/myshare
Type=cifs
Options=credentials=/etc/cifs-creds/myshare,iocharset=utf8,uid=33,gid=33,vers=3.0,_netdev
