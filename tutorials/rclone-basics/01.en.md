...
P.S.: To keep files moving while not connected via SSH on the server, a great program (for Linux) to use is `screen`. Details on this can be found [here](https://linuxize.com/post/how-to-use-linux-screen/).
