...
When using Windows, a command-line interface tool (e.g. [Putty](https://www.chiark.greenend.org.uk/~sgtatham/putty/)) and a File Transfer Protocol tool (e.g. [WinScp](https://winscp.net/eng/index.php)) are required. Linux offers these functionalities natively.
