...
При использовании Windows потребуются инструмент командной строки (например, [Putty](https://www.chiark.greenend.org.uk/~sgtatham/putty/)) и инструмент передачи файлов (например, [WinScp](https://winscp.net/eng/index.php)). В Linux необходимые инструменты уже есть.
