...
* [ownCloud](https://owncloud.com/) als Dateispeicher, vor allem um mit Partnern und Kunden Dateien auszutauschen
* [GITLab](https://about.gitlab.com/) als Anwendung zur Softwareentwicklung im Team

Unter Windows sind [Putty](https://www.chiark.greenend.org.uk/~sgtatham/putty/) als Kommandozeilentool und [WinScp](https://winscp.net/eng/index.php) für die Dateiübertragung nötig. Linux bietet diese Funktionen nativ an.
