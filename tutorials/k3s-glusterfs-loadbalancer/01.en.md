...
You can read more about the applied options in the [K3S documenation](https://rancher.com/docs/k3s/latest/en/installation/install-options/server-config/). In short:
...
The [System Upgrade Controller](https://github.com/rancher/system-upgrade-controller/) performs automatic updates of K3S. If you want to use this festure, install the controller using this command:
...
You can read more about the applied options in the [K3S documenation](https://rancher.com/docs/k3s/latest/en/installation/install-options/agent-config/). In short:
...
This will create and start a replicated volume names "k8s" with three replicas (our three VMs).
