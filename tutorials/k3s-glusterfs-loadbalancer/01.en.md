...
SSH into all three nodes and run the following command to install Gluster:
...
Create the load balancer and attach it to the private network:
...
Add the HTTP service for `<example.com>` and enable the health check:
