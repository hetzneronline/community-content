...
A tool GUI based Software for creating and automated renewing of SSL certificates and redirecting visitors to their requested target.
...
As another example, we will also secure and redirect an example service running on port 8080. 
...
`restricted.<yourdomain.com>` - This subdomain shall show you the use of the "Access Lists" tool. You can use it to restrict the access to some defined credentials (basic auth).
...
Here you now paste the following content. Please edit the password credentials to your own.
