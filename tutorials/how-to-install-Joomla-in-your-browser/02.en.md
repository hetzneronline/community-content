...
Once you have completed the steps described above, Joomla will be successfully installed on the Hetzner web hosting environment and ready to use.
The basic server configuration, database connection, and Joomla installation have been completed, meaning that the system can now be accessed and administered via your browser.
