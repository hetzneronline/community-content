...
Download latest Nagios Core 4.4.3 and Nagios plugins 2.2.1 packages. Go to the [Nagios downloads page](https://www.nagios.org/download/core-stay-informed), copy the link address for the latest stable release so you can download it to your Nagios server.
