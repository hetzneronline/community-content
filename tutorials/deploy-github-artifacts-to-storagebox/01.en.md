...
Keeping SSH open to the public internet is generally not recommended. If you have a server and plan to restrict SSH access (for example, by only allowing your own IP), you'll also need to whitelist GitHub Actions runner IPs to let your workflows connect to the server. This example uses iptables.
