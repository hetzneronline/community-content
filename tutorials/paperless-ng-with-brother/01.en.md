...
*NOTE:* Replace `brother4:net1;dev0` with the apropriate device name displayed when `scanimage -L` is called. If you scan something else than A4 please change `-x` and `-y` parameters accordingly. 
