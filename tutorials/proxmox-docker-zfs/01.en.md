...
Qemu is the software that will allow the [Rescue System](https://wiki.hetzner.de/index.php/Hetzner_Rescue-System/en) to create a VM. First, you will need to connect to the [Rescue System](https://wiki.hetzner.de/index.php/Hetzner_Rescue-System/en). You can do this by using an SSH client of your choice. Most OS's will have a client preinstalled, that you can access from the terminal. You can do that by opening CMD or Terminal, depending on the OS, and running the following command: 
