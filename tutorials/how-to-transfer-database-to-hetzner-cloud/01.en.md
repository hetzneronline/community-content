...
* An [SSH key](https://community.hetzner.com/tutorials/howto-ssh-key) added to your Hetzner Cloud account
...
DBConvert Streams offers a free trial so you can evaluate the platform before committing to a paid plan. For current trial limits, included features, and plan details, see the [pricing page](https://streams.dbconvert.com/pricing).
...
You have successfully migrated your database to Hetzner Cloud using DBConvert Streams. This setup provides:
...
(b) The contribution is based upon previous work that, to the best of my
    ...
    whether created wholly or in part by me, under the same license
