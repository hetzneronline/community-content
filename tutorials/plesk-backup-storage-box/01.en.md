...
* Server that has [Plesk installed](https://community.hetzner.com/tutorials/install-plesk-cloud-server)
* [Hetzner Storage Box](https://docs.hetzner.com/storage/storage-box/general)  


## Step 1 - Order Storage Box

You can order a new Storage Box in the [Hetzner Console](https://console.hetzner.com/) as explained in [this getting started](https://docs.hetzner.com/storage/storage-box/getting-started/creating-a-storage-box).
...
After the Storage Box is created, you can click on it to view the access details. You can change the password via the action "Reset password".

![Storage Box](images/01_storage_box.png)

In the [Hetzner Docs](https://docs.hetzner.com/storage/storage-box), you can find a Quick Start Guide for Storage Boxes with helpful information.

## Step 2 - Setup the Backup in Plesk

After you have ordered your Storage Box and created an account, it is time to set up the backups in Plesk. After you logged in to Plesk, go to:

"Tools & Settings" » "Tools & Resources" » "Backup Manager"

The Backup Manager itself normally stores all backups locally on your server. In order to have it saved in the Hetzner Storage Box, it needs to be configured to do so.

![Storage Box](images/02_backup_manager_empty.png)

Click on "Remote Storage Settings" within the Backup Manager. Now click on "FTP(S)" and enter your credentials.

![FTP Storage Settings](images/03_ftp_settings.png)
...
![Backup Settings](images/04_backup_settings.png)
...
![Backup Security Settings](images/05_backup_security.png)
...
![Backup content](images/06_backup_content.png)
...
![Restore Backup](images/07_restore_backup.png)
