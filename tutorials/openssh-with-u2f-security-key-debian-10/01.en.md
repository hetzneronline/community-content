...
- A Hetzner server running Debian 10, either dedicated or from Hetzner Cloud.
...
While writing this tutorial it was tested on a fresh Hetzner Cloud CPX11 instance however it will run perfectly fine on other cloud instances or dedicated servers.
...
Optionally, you can speed up the process of downloading these packages by adding an entry to download from the [Hetzner APT Mirror](https://wiki.hetzner.de/index.php/Hetzner_Aptitude_Mirror/en):
...
You can check out the installation and usage instructions here: https://github.com/mgbowen/windows-fido-bridge#build-windows-fido-bridge-from-source
