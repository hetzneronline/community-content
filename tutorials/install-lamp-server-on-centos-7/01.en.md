...
***Note:*** In this example 10.0.0.1 is the IP address of your server
...
To access phpMyAdmin, enter the following URL in your browser: [http://10.0.0.1/phpmyadmin](http://10.0.0.1/phpmyadmin)
