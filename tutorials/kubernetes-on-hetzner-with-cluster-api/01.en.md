...
Next, create an SSH key pair locally if you do not already have one. Then upload the public key to your Hetzner Cloud project, either in the Cloud Console or with the `hcloud` CLI:
...
kubectl get endpoints caph-webhook-service -n caph-system
```
