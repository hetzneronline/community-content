...
As usual, clear text passwords are bad. As such, you should specify your private key and use it to avoid password login, as explained in the [Hetzner Wiki](https://docs.hetzner.com/robot/storage-box/backup-space-ssh-keys/).
