...
<blockquote>
<details>
<summary>Click here if you have IPv6-only</summary>

This section is only relevant if your server does NOT have a public IPv4 address. If your server does have a public IPv4 address, you can skip directly to the Docker command below.
...
To make the ONLYOFFICE Docker container accessible via HTTPS exclusively through the public IPv6 address, add `/etc/docker/daemon.json`:
...
The letsencrypt.org CA-signed certificate will be automatically generated and installed to your server. Now your ONLYOFFICE Docs should be available at the https://example.com address. You can also check `https://example.com/welcome/`.
