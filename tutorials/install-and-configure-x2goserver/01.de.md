...
**Voraussetzungen**
 ...
 - IP-Adresse
 - root Zugang zum Server per SSH Key [See our tutorial for reference](https://community.hetzner.com/tutorials/add-ssh-key-to-your-hetzner-cloud)
...
- Für Ubuntu:
  ...
  Tip: Womöglich muss der Befehl 2 mal ausgeführt werden, da in wiederholten Tests die Installation des Desktops abbricht. Danach funktioniert die Installation problemlos.
...
Für die Smarten kann man alle bisherigen Befehle in einer einzigen Zeile ausführen:

Ubuntu: `apt update && apt upgrade -y && apt install xubuntu-desktop x2goserver x2goserver-xsession -y`
- Fertig in 16:58 minutes
...
Erstellen Sie eine neue Sitzung im Client und fügen Sie die Parameter für Ihren Server ein.
 ...
 - Sitzungsart: XFCE für Ubuntu
 - ODER: LXDE für Debian
...
- Kompressionsalgorytmus kann auf 256-jpeg eingestellt werden um die Farbpalette zu beschränken. Diese Palette ist hoch-dynamisch, weshalb 256 Farben selten limitierend sind.

Ein-/Ausgabe:
- Eigener: Einstellung für Größe im Fenstermodus
- Ganzen Bildschirm verwenden: Vollständiges Ausfüllen eines Bildschirmes (Bildschirm nummer wählbar)
