...
# Create 2 cx23 servers with debian-12 in Nuremberg that are accessible wih your SSH key
hcloud server create --ssh-key my-ssh-key --location nbg1 --type cx23 --image debian-12 --name server1
hcloud server create --ssh-key my-ssh-key --location nbg1 --type cx23 --image debian-12 --name server2
