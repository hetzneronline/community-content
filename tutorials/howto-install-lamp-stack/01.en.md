...
short_description: "This tutorial explains the simple installation of a LAMP (Apache, MySQL, PHP) stack on Ubuntu/Debian servers."
...
header_img: "https://vgy.me/zQLNgc.jpg"
---
...
As Apache's default location is /var/www/html, we will create a new **info.php** file using **nano** by running this command:
```bash
sudo nano /var/www/html/info.php
```
Nano text editor will now be opened. We will use it to run our info script with PHP. Insert the following text into the **info.php** file:
```php
<?php
phpinfo();
?>
```
We will save and close the file by using CTRL + X.
...
Apache, MySQL and PHP are now running on our server and harmonizing together. You can now upload your files and scripts to /var/www/html and start using your web server.
