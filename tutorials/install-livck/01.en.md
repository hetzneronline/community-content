...
I recommend the Hetzner cloud server **CX23**, which offers sufficient performance, the **location** of the server is up to you. In the tutorial, we will use **Falkenstein** as location.
