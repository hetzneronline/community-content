...
path: "install-livck-on-ubuntu-20-04"
slug: "how-to-install-livck-on-hetzner-cloud"
date: "2021-08-14"
title: "Install LIVCK on the Hetzner Cloud (Ubuntu 20.04)"
short_description: "This tutorial explains step by step how to install the monitoring software LIVCK (self-hosted) on your own cloud server."
...
The prerequisite for this installation is to have a Hetzner cloud server that runs on **Ubuntu 20.04** or newer.

I recommend the **CX21**, which offers sufficient performance, the **location** of the server is up to you. In the tutorial, we will use **Falkenstein** as lcoation.
...
```shell
composer install --no-dev --optimize-autoloader --ignore-platform-reqs && chmod 777 * -R
```
...
The software is now fully functional, now you can already start adding your services to monitor them.
