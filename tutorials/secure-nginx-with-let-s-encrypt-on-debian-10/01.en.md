...
path: "/tutorials/secure-nginx-with-let-s-encrypt-on-debian-10"
slug: "secure-nginx-with-let-s-encrypt-on-debian-10"
date: "2019-06-30"
title: "How to Secure Nginx with Let's Encrypt on Debian 10"
short_description: "This tutorial explains how to install and secure Nginx with Let's Encrypt on Debian 10"
...
In this tutorial, we will show you how to use the `certbot` Let's Encrypt client to obtain a free SSL certificate and use it with Nginx on Debian 10. We will also show you how to automatically renew your SSL certificate.

**Prerequisites**

To install Nginx and setup Let's Encrypt using certbot, you need:

- A Debian 10 server with a `sudo` user.
...
Nginx is available in the default Debian 10 repository, it is possible to install it from these repositories using the apt packaging system.
...
In this tutorial you have learned how to secure Nginx with Let's Encrypt SSL on Debian 10 with certbot and setup automatic certificate renewal.
