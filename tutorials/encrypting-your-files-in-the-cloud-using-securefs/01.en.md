...
> If you have multiple PCs that you want to sync, you need to make sure that you downloaded changes from the remote server,
...
### Step 1.5 - Using securefs in combination with sshfs
