...
```sudo
sudo wget https://releases.shopware.com/sw6/install_v6.4.20.0_52e67425204f8bec1d1c67608f82008710f7611b.zip
```

Unzip:

```sudo
sudo unzip install_v6.4.20.0_52e67425204f8bec1d1c67608f82008710f7611b.zip
```

Remove zip:

```sudo
sudo rm install_v6.4.20.0_52e67425204f8bec1d1c67608f82008710f7611b.zip
```
