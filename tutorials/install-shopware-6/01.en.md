...
After initial configuration, change the root `/var/www/html;` to `/var/www/html/public;`, restart nginx `sudo systemctl restart nginx` and proceed with the first run wizard.
