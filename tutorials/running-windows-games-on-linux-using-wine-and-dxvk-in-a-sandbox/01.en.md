...
> the DLL names will prefixed with asterisk `*`.

![DXVK DLL overrides](images/dxvk_overrides.png)

If it's not the case, make sure that directory of your `WINEPREFIX` actually exists on disk:
...
<summary><b>If you want play an OpenGL game and MangoHud doesn't work...</b></summary>
