...
Do not host Vaultwarden and other applications on the same host if not absolutely required. The attack surface should be as small as possible any added complexity from other applications
...
ignoreregex =
```
[credit](https://github.com/dani-garcia/vaultwarden/wiki/Fail2Ban-Setup)
