...
2. Remove any packages that may have been installed previously.
...
4. Run a persistent caddy daemon in another Docker container.

   
3. Create a directory in /etc for Caddy to keep state information like Let's Encrypt certificates.
...
![alt text](images/BWFront.png "BitWarden Web Vault")
...
![alt text](images/Create-Account.jpg "BitWarden Web Vault")
...
![alt text](images/Vault.png "BitWarden Web Vault")
...
![alt text](images/Result-Of-Preventing-Further-Signups.png "BitWarden Web Vault")
