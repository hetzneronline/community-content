...
I develop "https://api.tingtao.org/cfg.php" for build config file of php/mariadb/proftpd/nginx , the doc is here (Chinese) : https://www.tingtao.org/archives/1843.html <br />
...
reboot os if the kernel has upgraded :
