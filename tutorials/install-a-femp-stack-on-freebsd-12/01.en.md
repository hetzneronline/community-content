...
path: "/tutorials/setup-femp-stack-on-freebsd"
slug: "01.en.md"
date: "2019-05-12"
...
* A Hetzner Robot/Cloud server running FreeBSD 12.
...
To install Nginx, the web server we are using for this tutorial, do the following command:
...
Test that it is working by going to your IP address in a web browser. You can check your server's IP address by running `fetch -qo- http://ifconfig.co`, or by checking your Hetzner control panel.
...
Now that we have Nginx and PHP setup and working together, the only thing left we need to install and configure is MySQL.
