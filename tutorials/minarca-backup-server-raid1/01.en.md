...
[Minarca](https://github.com/ikus060/minarca) is an open-source, self-hosted backup solution built on top of [rdiff-backup](https://github.com/rdiff-backup/rdiff-backup). It gives you a central web interface where you can manage backup clients, browse and restore files from past backups, and monitor backup status across multiple machines - without relying on a third-party cloud backup service.
...
Add the required dependencies and the Minarca APT repository as explained in the [official documentation](https://gitlab.com/ikus-soft/minarca/-/blob/master/doc/installation.md):
...
* [Minarca official documentation](https://minarca.org/doc)
