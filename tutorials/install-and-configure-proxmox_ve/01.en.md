...
Once the network configuration section has been reached, make sure that "Pin network interface names" is checked. After the installation simply reboot the server.
