...
* IP-Adressen aus zusätzlichen Subnetze sind nur auf dem Host-System oder einer einzelnen VM mit einer Einzel-IP (sofern das Subnetz auf diese geroutet ist) nutzbar (gilt auch für IPv6)
