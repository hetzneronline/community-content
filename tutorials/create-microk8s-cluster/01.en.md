...
This tutorial was created on Ubuntu 24.04 and the instructions were tested there. It should work from any operating system with proper adaption of the instructions.
...
local$ hcloud server create --type cx23 --name node-1 --image ubuntu-24.04 --ssh-key <ssh_key_id> --network <network_id>
local$ hcloud server create --type cx23 --name node-2 --image ubuntu-24.04 --ssh-key <ssh_key_id> --network <network_id>
```
