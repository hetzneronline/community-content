...
Now have to acquire a Hetzner-DNS API-Token. You can create yours here: https://dns.hetzner.com/settings/api-token
...
![add-datasource-details](add-datasource-details.png)
...
![import-dashboard-further](import-dashboard-further.png)

Rename it to your needs and import it accordingly.

![import-dashboard-detailed](import-dashboard-detailed.png)

Save the dashboard by clicking the "save" icon in the upper right corner. 

![save-dashboard.png](save-dashboard.png)
