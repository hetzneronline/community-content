...
date: "2021-05-27"
title: "Monitor your Servers on Grafana with InfluxDB and Telegraf on Ubuntu 20.04"
short_description: "A Guide to install and set up a monitoring System, consiting of Telegraf as as exporter, InfluxDB as Timedatabase and Grafana for Data visualation.
...
![grafik](tutorials/server-monitoring-using-grafana-and-influxdb/header-image.png)
...
```
$ systemctl start the nginx.service
```
...
![grafik](tutorials/server-monitoring-using-grafana-and-influxdb/add-datasource.png)

With "Add data source" you can add your local InfluxDB Database

Configure it as follows:
![grafik](tutorials/server-monitoring-using-grafana-and-influxdb/add-datasource-details.png)

Now that we have a working datasource for Grafana, we can start importing a Dashboard for your Server.

![grafik](tutorials/server-monitoring-using-grafana-and-influxdb/import-dashboard.png)
...
![grafik](tutorials/server-monitoring-using-grafana-and-influxdb/import-dashboard-further.png)

Rename it to your needs and import it accordingly.

![grafik](tutorials/server-monitoring-using-grafana-and-influxdb/import-dashboard-detailed.png)

Save the dashboard by clicking the "save" icon in the upper right corner. 

![grafik](tutorials/server-monitoring-using-grafana-and-influxdb/save-dashboard.png)
...
You can now use Grafana. For example you can now create additional dashboards and users. Grafana also offers an alerting function in case of e.g. unavailability of a specific target value.
