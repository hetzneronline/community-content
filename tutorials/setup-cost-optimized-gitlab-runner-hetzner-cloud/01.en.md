...
path: "/tutorials/setup-cost-optimized-gitlab-runner-hetzner-cloud"
slug: "setup-cost-optimized-gitlab-runner-hetzner-cloud"
date: "2026-01-16"
...
author_img: "https://avatars.githubusercontent.com/u/devmaxde"
...
| Monthly cost (CCX23) | ~€50                      | ~€4             |

**Prerequisites**

- A Hetzner Cloud account with an [API token](https://docs.hetzner.com/cloud/api/getting-started/generating-api-token)
- A GitLab instance (self-hosted or gitlab.com) with a [Personal Access Token](https://docs.gitlab.com/ee/user/profile/personal_access_tokens.html)
- A server to run the orchestrator (can be a small CX11 or even a Raspberry Pi)
...
Create a Hetzner Cloud API token to allow the orchestrator to create and delete servers.
...
| Option                  | Description                                                                                                        |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------ |
| `server_type`           | Hetzner server type. `ccx23` (AMD dedicated) is great for CI. See [Hetzner pricing](https://www.hetzner.com/cloud) |
...
Trigger a pipeline in one of your GitLab projects. The orchestrator should:
...
Signed-off-by: Maximilian Kutschka
