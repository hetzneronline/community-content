...
class PrivateDocumentAdmin(admin.ModelAdmin):
    ...
    def get_fields(self, request, obj=None):
        ...
        # Zeige den Link nur beim Bearbeiten bestehender Objekte
        if obj:
...
- **PrivateDocumentAdmin**:
  ...
  - Das Feld `get_file_url` wird nur im Bearbeitungsmodus angezeigt (nicht beim Anlegen eines neuen Dokuments).
