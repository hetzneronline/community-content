...
short_description: "In diesem Beitrag geht es um die einrichtung eines Paketfilters auf Linux Systemen."
...
Hier sind alle Verfügbaren CLI Parameter für das erstellen der Filterregeln aufgelistet.
Option |	Beschreibung
|---|---
...
Die konfigurierten Firewall Regeln sind nicht automatisch persisten gespeichert um dies zu ändern muss folgendes Paket nachinstalliert werden `iptables-persistent`
