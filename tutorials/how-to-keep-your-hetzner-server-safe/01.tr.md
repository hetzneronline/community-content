...
Yeni bir kullanıcı oluşturmak için [Initial Server Setup with Ubuntu](https://community.hetzner.com/tutorials/howto-initial-setup-ubuntu) yazısını takip edin. Ancak, 6.adımı atlayın, güvenlik duvarı konusunu burada işleyeceğiz.
