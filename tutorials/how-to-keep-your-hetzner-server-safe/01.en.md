...
Make sure to follow the [Initial Server Setup with Ubuntu](https://community.hetzner.com/tutorials/howto-initial-setup-ubuntu) tutorial to create a new user. However, skip the step 6, we will cover the firewall installation.
