...
hulo@your_host:/path/on/remote/server /mnt/mymountpoint fuse.sshfs IdentityFile=/home/hulo/.ssh/id_rsa,noauto,nofail 0 0
```
...
hulo@your_host:/path/on/remote/server /mnt/mymountpoint fuse.sshfs IdentityFile=/home/hulo/.ssh/id_rsa,noauto,nofail,x-systemd.automount,x-systemd.idle-timeout=60s 0 0
```
Explanation:
...
Type=fuse.sshfs
Options=IdentityFile=/home/hulo/.ssh/id_rsa,noauto,nofail,x-systemd.automount,x-systemd.idle-timeout=60s
