...
> **Note:** You man find [Installing WireGuard VPN on Ubuntu](https://community.hetzner.com/tutorials/install-and-configure-wireguard-vpn/) tutorial useful if you want to configure a WireGuard server to provide the Internet access to the various client devices.
...
* where `203.0.113.1` is your server IP address.
