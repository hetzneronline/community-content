...
Um den Status der LSI RAID-Controller auszulesen muss das Commandline-Tool `megacli` von LSI installiert sein. Im [Hetzner Rescue-System](https://wiki.hetzner.de/index.php/Hetzner_Rescue-System) ist dies bereits der Fall.
