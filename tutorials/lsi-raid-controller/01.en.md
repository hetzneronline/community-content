...
To read the status of the LSI RAID Controller, the LSI `megacli` command-line tool needs to be installed. This is already pre-installed in the [Rescue-System](https://wiki.hetzner.de/index.php/Hetzner_Rescue-System/en).
...
This article demonstrates different RAID configuration possibilities on your server with LSI hardware RAID controller. You should have configured it to your liking by now.
