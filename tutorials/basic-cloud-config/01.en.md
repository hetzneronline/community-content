...
An additional, optional feature during creation of a Hetzner cloud server (CX23 and above) is _user data_. This allows the execution of a _cloud-init_ configuration for the newly created server.
