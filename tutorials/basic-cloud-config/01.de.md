...
Sie sollte mit einem Kommentar in der ersten Zeile starten:
...
### Schritt 3.1 - Pakete aktualisieren
...
Dieses Tutorial nutzt _apt-get_. Vielleicht musst du die Befehle entsprechend des verwendeten Paket-Managers anpassen.\
Da alle Befehle als _root_-Benutzer ausgeführt werden, brauchen wir in diesem Fall kein `sudo` voranstellen.

```yaml
  - apt-get update && apt-get dist-upgrade -y
```

### Schritt 3.2 – fail2ban installieren

Mit den Paketlisten auf dem neuesten Stand, ist es nun einfacher etwas neues zu installieren.
