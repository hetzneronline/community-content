...
* 2 Plesk control panel is installed Via [Plesk installation tutorial](https://community.hetzner.com/tutorials/install-plesk-cloud-server)
...
Signed-off-by: Mohamamdreza ahm <mohammadr3z@icloud.com>
