...
This will create a new server with the name `my-server`, the image `ubuntu-24.04` and the server type `cx23`. When you now run `terraform apply` and confirm the message by typing `yes` ENTER, you should see a freshly created CX23 server in the [Hetzner Cloud Console](https://console.hetzner.cloud)!
...
You now have learned how to create a resource. Now I want to show you how easily you can create a bunch of resources and combine them. We will use a basic CX23 server and a volume in this step.
