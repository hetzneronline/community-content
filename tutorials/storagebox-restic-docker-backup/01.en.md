...
<blockquote>
<details>
<summary>Click here if the <code>-s</code> option is not available</summary>

Run this command on your local device that has the SSH key:
...
sftp> mkdir .ssh
sftp> cd .ssh
sftp> put /home/<user>/.ssh/restic.pub authorized_keys
sftp> exit
```
