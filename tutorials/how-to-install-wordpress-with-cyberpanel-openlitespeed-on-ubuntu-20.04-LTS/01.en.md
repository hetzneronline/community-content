...
* Change DNS to Hetzner DNS (see [this guide](https://docs.hetzner.com/networking/dns/overview#authoritative-name-servers))
...
* Login to [Hetzner Console](https://console.hetzner.cloud/)
...
When you are done with creating a cloud server, you are ready to add relative DNS records to DNS in Hetzner Console.

* In the left menubar in [Hetzner Console](https://console.hetzner.com/), navigate to DNS
* Add New Zone.
* Enter your domain (in this tutorial I already setup proper DNS records for my domain).
* Add A records for `@`, `www` and `mail`. Copy your server **IPv4 Address** and paste in to **A record** and set TTL. TTL stands for "Time To Live" in seconds. (eg. TTL 3600 = 1 hours)
* You will see the zone records as below:
