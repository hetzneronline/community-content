...
Schnritt 3 erklärt, wie die übrigen Partitionen nach links verschoben werden können, sodass der freie Speicherplatz rechts aller Partitionen ist:
...
Dazu habe ich das [Rescue System](https://docs.hetzner.com/de/robot/dedicated-server/troubleshooting/hetzner-rescue-system#starten-des-hetzner-rescue-systems) von Hetzner verwendet, 
das über das Netzwerk gestartet wird und über die [Administrationsoberfläche](https://accounts.hetzner.com/) aktiviert werden kann.
...
Um in Schritt 4 eine RAID-Partition zu vergrößern, müssen alle Festplattenpartitionen (auf allen Festplatten des RAID-Verbunds) so verschoben werden, dass der freie Speicherplatz unmittelbar rechts von der zu vergößernden Partition ist.
