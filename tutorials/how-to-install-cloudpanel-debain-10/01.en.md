...
![](images/cloudpanel-installed.png)

## Step 3 - Login CloudPanel & Create User

Your server is now set up and ready to use. You can log in at : 
https://your-ip-or-URL:8443. When we log in the first time, we need to create Admin User.
