...
This simple tutorials explains how to deploy Teampass password manager on a stand-alone server. In a few steps all needed will be installedd and configured. It is also recomended to deploy som hardening tools like fail2ban and firewall because the server is exposed to internet.

**Prerequisites**

* Ubuntu sever 16.X/18.X
* Root access
* MySQL
* PHP
* Apache
