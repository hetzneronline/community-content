...
* `http://localhost:9999/api/v1/login` from our login page (through proxy)
* `http://localhost:9999/api/v1/logout` from our login page (through proxy)
* `http://localhost:9999/api/v1/validate` from any protected site as Nginx authentication preflight request (through internal proxy)
