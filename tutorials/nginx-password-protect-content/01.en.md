...
> _**NOTE:** In the previous [tutorial](https://community.hetzner.com/tutorials/secure-fedora-webserver#step-7---acquire-a-wildcard-certificate-and-setup-ssl "Visit") we already set up SSL certificate (and -renewal) for a specific wildcard domain, see the link for details. 
