...
|--------|-----|------|-----|-----|----------|
| **GEX45** | NVIDIA RTX PRO™ 4000 Blackwell SFF | 24 GB GDDR7 | 64 GB | Intel® i5-13500 | Running 7B-14B parameter models comfortably |
...
This tutorial uses the **GEX45** as the baseline - it is the most affordable option and has enough VRAM to run popular models like Gemma 3 12B, Phi 4 14B, and Mistral Small 24B. If you need to run larger models (e.g., Llama 3.3 70B), choose the GEX131 with its 96 GB of VRAM.

**Prerequisites**

* A GPU Dedicated Server, e.g. [with Hetzner](https://www.hetzner.com/dedicated-rootserver/matrix-gpu/) (GEX45 or GEX131)
...
Pull [Gemma 4 12B](https://ollama.com/library/gemma4), Google's latest open model with vision and tool-calling support, making it an excellent starting point for the GEX45's 24 GB of VRAM:
...
**GEX45 (24 GB VRAM) - these all fit in GPU memory:**
