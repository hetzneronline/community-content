...
Now, let's add the first client. Client object looks like this:
...
<summary>After you added client, configuration will look like this:</summary>
...
Now you need to create a JSON object for certificate and add it to your Xray server configuration.
...
<summary>After you added self-signed certificate, configuration will look like this:</summary>
...
Certificate and private key will be saved into `/etc/letsencrypt/live/example.com` directory, where `example.com` is your domain.
...
<summary>After you added your Let's Encrypt certificate, configuration will look like this:</summary>
...
8. Tap to check connection, it should be successful:
