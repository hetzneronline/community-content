...
> _**NOTE:** Since at login time `npm` can't decide between the repositories based on a package's scope, we need to explicitly tell the scope & registry combination. Do a login for **all** scopes you set up!_
