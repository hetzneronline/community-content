...
>_**NOTE:** Most of these steps we already covered in a [previous article](https://community.hetzner.com/tutorials/nginx-auth-preflight-nodejs-api "Open"), so this time only bullet-points will be listed, feel free to use the old article as reference. 
