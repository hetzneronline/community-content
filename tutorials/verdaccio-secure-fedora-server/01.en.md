...
1. Create a DNS `A` record containing `registry` in the `<your-domain>` zone with your server's IP address, for example in [Hetzner Console](https://console.hetzner.com/ "Open").
