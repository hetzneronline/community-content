...
Please replace `<10.0.0.1>` with your own IP address. If there is a warning about _host authenticity_, you can enter _yes_. The ssh command will save the fingerprint shown in the warning in the file `~/.ssh/known_hosts` and automatically recognize it in the future. 
