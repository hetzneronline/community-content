...
Beachten Sie bitte, dass `<10.0.0.1>` mit der eigenen IP-Adresse ersetzt werden muss. Sollte eine Warnung bezüglich _host authenticity_ erscheinen, kann _yes_ angegeben werden. Der Server wird den in der Warnung angegebenen Fingerprint speichern und in Zukunft automatisch erkennen.
