...
## if you want you can activate an access to the traefik dashbord here. You can then access the dashboard at http://gitlab.example.com:8090
#[web]
#address = ":8090"
#[web.auth.basic]
...
When everything is ready, what we need in this step, we should reach gitlab at gitlab.example.com. Now we can go to the next step.
