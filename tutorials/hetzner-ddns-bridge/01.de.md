...
> <small>Gespiegelt von https://github.com/woehrl/hetzner-dyndns, Commit `ceec8dd`. Kopiere sie auf deinen Webspace oder eine kleine VM.</small>
...
|    | Beschreibung |
| -- | ------------ |
| <kbd style="background-color:#e2e2e2!important;color:#000;border-radius:6px;">script_password</kbd> | Bestimme ein starkes, geteiltes Passwort. Dein Router nutzt es. |
