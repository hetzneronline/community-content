...
> <small>Mirrored from https://github.com/woehrl/hetzner-dyndns, commit `ceec8dd`</small>
...
|    | Description |
| -- | ----------- |
| <kbd style="background-color:#e2e2e2!important;color:#000;border-radius:6px;">script_password</kbd> | Set a strong shared password. Your router will use this. |
