...
In this how-to you will learn how to use the Hetzner Cloud S3 Storage as a backend for terraform. This allowed me to centralize Terraform backends and gave me the ability to easily reuse remote states into different projects. To aid newcomers, I will be using WebUI to show all steps, but I'll also provide Hetzner CLI commands at the end of the tutorial.
...
Open main.tf with preferred text editor and copy the content. Replace placeholders with your actuals values. (Don't worry about me 'leaking' my credentials, they have been rotated as I'm writing this tutorial :) )
...
```
Export these variables in your terminal session, use Access Key and Secret Key that you saved before. Leave AWS_DEFAULT_REGION as is with any valid AWS region:
```bash
...
tofu init
```
If you see this output in your console, Congrats! it means setup was a success.
```bash
❯ tofu init               
