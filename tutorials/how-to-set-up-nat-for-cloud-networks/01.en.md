...
Note that it is currently not possible to set up a dedicated server as router for the Private Network (see [this FAQ entry](https://docs.hetzner.com/networking/networks/faq#can-i-set-up-a-dedicated-server-as-router)).
