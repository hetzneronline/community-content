...
> Wenn die externe Zone nicht zwingend benötigt wird, empfehlen wir, in der Hetzner Console eine [Primäre Zone zu erstellen](https://docs.hetzner.com/de/networking/dns/getting-started/creating-a-zone) und [die Domain auf Hetzner-Nameserver zu delegieren](https://docs.hetzner.com/de/networking/dns/getting-started/delegate-to-hetzner), sodass die Domain vollständig in der Hetzner Console verwaltet wird. Dadurch wird vermieden, dass die Records und die Zertifikatsverwaltung zwischen verschiedenen Anbietern aufgeteilt sind. Alles an einem Ort zu haben, macht die Verwaltung der Zone übersichtlicher und einfacher.
...
Danach ist die Einrichtung des Zertifikats abgeschlossen. Nun können die DNS-Einträge, die für den jeweiligen Service benötigt werden, in der [Hetzner Console](https://console.hetzner.com/) angelegt werden. Dafür muss schlicht ein `A` Record hinzugefügt werden, in welchem die (Sub-)Domain auf den Load Balancer zeigt. Beispiel:
