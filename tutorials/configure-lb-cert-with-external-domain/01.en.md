...
After that, the certificate setup is complete. Now, you can go back to the Hetzner [DNS Console](https://console.hetzner.com/) and create the DNS entries required for the respective service. To do this, simply create a new `A` record that points your (sub-)domain at the Load Balancer. For example:
