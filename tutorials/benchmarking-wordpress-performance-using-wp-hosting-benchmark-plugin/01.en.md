...
path: "/tutorials/benchmarking-wordpress-performance-using-wp-hosting-benchmark-plugin"
slug: "benchmarking-wordpress-performance-using-wp-hosting-benchmark-plugin"
date: "2026-01-08"
...
tags: ["Server", "Performance", "Benchmark", "WordPress", "Hosting", "Hetzner Cloud"]
author: "Faleddo"
...
# Benchmarking WordPress Performance Using WP Hosting Benchmark
...
Measures raw PHP execution speed, including loops, mathematical operations, string processing, and memory usage behavior.

* **File System**
Measures disk read/write speed and temporary file handling, reflecting storage and filesystem performance.

* **Database**
Measures database query performance using INSERT, SELECT, UPDATE, and DELETE operations.

* **Object Cache**
Measures object allocation, reuse, and cleanup efficiency inside PHP memory (without requiring an external cache backend).

* **WordPress Core**
Measures how efficiently the server executes internal WordPress logic, including shortcode processing, hooks, option handling, taxonomy operations, content filtering, and common data manipulations such as REGEX and JSON.

* **Network**
Measures basic network-related operations inside PHP, such as socket handling and internal data transfer overhead.
...
Access the WordPress dashboard as an administrator.
...
After plugin installed, enable caching to make it works. To enable Redis object caching:
...
After Redis object caching enabled, open WP Hosting Benchmark.

```
Tools -> WP Hosting Benchmark
```

Accept the terms, then click the "Run Benchmark" button. 
![Accept Terms](images/wpbench_accept.jpg)

Wait for the process to complete. After benchmark process completed, you will get result like this:
![Benchmark Result](images/wpbench_result_1.jpg)

---
## Step 2 - Comparing Benchmark Result Between Hetzner Cloud Server
...
### Test 1: Shared Cost Optimized

#### Characteristics

Cost Optimized server instances are designed to be:
...
#### When to Choose Cloud Optimized VPS
...
**Best for:**
Growing business websites, SaaS dashboards, internal tools, medium-traffic WordPress.

---

### Test 2: Shared Regular Performance

#### Characteristics

Shared Regular Performance servers:

* Share CPU cores and storage I/O
* Cost-efficient
* Have less predictable performance
![Benchmark Result](images/wpbench_result_2.jpg)

#### When to Choose Shared Regular Performance
...
**Best for:**
Personal blogs, development environments, staging sites.

---

### Test 3: Dedicated General Purpose

#### Characteristics

Dedicated General Purpose servers provide:

* Fully dedicated CPU cores
* Dedicated memory
* No noisy neighbors
* Highly predictable performance
![Benchmark Result](images/wpbench_result_3.jpg)

#### When to Choose Dedicated General Purpose
...
**Best for:**
High-traffic WordPress sites, WooCommerce stores, membership platforms, enterprise workloads.

---

### Summary: Choosing the Right Server Type
