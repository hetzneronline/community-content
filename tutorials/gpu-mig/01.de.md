...
* Prüfe den GPU-Status, die Kernel-Version und die GPU vBIOS-Version:
  ...
  ```
  Der Output sollte "MIG devices" enthalten. Wenn du eine RTX PRO 6000 Blackwell GPU hast, vergleiche deine vBIOS-Version mit der Mindestanforderung, die in der [NVIDIA-Dokumentation](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/latest/getting-started-with-mig.html#additional-prerequisites-for-rtx-pro-blackwell-gpus) angegeben ist.
