...
* Check GPU status, kernel version, and GPU vBIOS version:
  ...
  ```
  In the output, you should see MIG devices. If you have a RTX PRO 6000 Blackwell GPU, compare your vBIOS version with the minimum vBIOS version mentioned in the [NVIDIA documentation](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/latest/getting-started-with-mig.html#additional-prerequisites-for-rtx-pro-blackwell-gpus).
