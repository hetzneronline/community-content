...
date: "2022-01-11"
title: "Linux: Datenträger formatieren und einhängen"
short_description: "In diesem Tutorial wird gezeigt, wie man unter Linux einen Datenträger formatiert, einhängt und wieder aushängt."
...
## Einführung
In diesem Tutorial wird erklärt, wie Sie unter Linux einen Datenträger formatieren, einhängen und in der `fstab`-Datei hinterlegen können. Das Formatieren beinhaltet das Hinzufügen einer neuen Partition und eines Dateisystems.
...
- `discard`: Aktiviert TRIM, womit ungenutzte oder ungültige Speicherblöcke für eine Wiederbeschreibung markiert werden, was hauptsächlich bei SSD Geräten hilfreich ist.
...
Im vorangegangenen Tutorial haben Sie gelernt, wie Sie den Namen Ihres Datenträgers herausfinden, eine Partition erstellen, ein Dateisystem hinzufügen, den Datenträger bzw. die Partition einhängen und in der `fstab`-Datei hinzufügen.
