...
This tutorial demonstrates how to install and configure the Plex Media Server on CentOS 8. You can perform the same steps on both Hetzner Cloud & Hetzner Dedicated Servers or any server running CentOS 8.
