...
A Hetzner cloud server of type CX23 neatly fits those requirements (we even get more storage than we need).
Any other, bigger cloud server (or even bare metal) would also work, but we're choosing a CX23 for this guide.
