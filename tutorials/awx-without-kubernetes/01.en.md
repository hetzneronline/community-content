...
A cloud server of type CX21 neatly fits those requirements (we even get more storage than we need).
...
You can find the currently latest version [on their releases page](https://github.com/ansible/awx/releases/latest).
