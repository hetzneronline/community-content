...
### Schritt 4.1 - Mögliche Probleme

Wenn Sie eine Fehlermeldung im Zusammenhang mit device-mapper sehen, müssen Sie möglicherweise das initramfs neu erstellen, da Sie sonst die verschlüsselte Partition nicht entsperren können.
