...
* <kbd>molecule.yml</kbd>
  ...
  | `platforms`  | Molecule uses this information to determine instance creation, naming, and grouping. If you want to test your role against various Ubuntu flavors (e.g., 18.04, 20.04, 22.04 or even with other distros like Centos etc.,), you can define them in this section. |
