...
You can now open Kibana in a web browser by entering `<your_server>:5601` (or `https://<kibana_your_server` if you have followed the security suggestions) in the URL bar.
