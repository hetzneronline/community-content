...
* * If you are working with a WSL subsystem, you can directly use the computed data in the `/output` folder.
  * If you are working on two separate systems, you need to copy the data from the server into the `/output` folder on your Windows computer.
