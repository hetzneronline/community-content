...
* * Wenn du mit einem WSL Sub-szstem arbeitest, kannst du direkt die berechnetten Daten in dem `/output` folder verwenden.
  * Wenn du auf zwei seperaten seperaten systemen arbeitest, musst du die Daten von dem Server in den `/output` folder deines Windows Computers kopieren.
