...
1. Run cfdisk with second drive and repeat steps 3-8.
   ```shellsession
...
- **Create a OpenZFS pool and root dataset**
...
## Step 8 - Setup mirrored swap device (Optional)
...
Congratulations! You have now a working FreeBSD installation with root
on a (mirrored) OpenZFS pool.
