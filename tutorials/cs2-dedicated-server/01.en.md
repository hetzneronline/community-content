...
path: "/tutorials/cs2-dedicated-server"
slug: "cs2-dedicated-server-2026-hetzner"
date: "2025-12-25"
title: "Counter-Strike 2 Dedicated Server in 2026 with Hetzner"
short_description: "Learn how to host your own Counter-Strike 2 dedicated server with Hetzner in simple steps to enjoy the game your way with friends outside the network"
tags: ["Ubuntu", "CX33", "Firewall", "Gaming", "CS2", "Server"]
author: "BakirGracic"
...
Counter-Strike 2 allows anyone to host dedicated servers free of charge using Valve's SteamCMD tool. However, hosting from your personal computer introduces network complexity and reliability issues. This tutorial guides you through setting up a production-ready CS2 dedicated server on Hetzner Cloud. This is a cost-effective and scalable solution that ensures your server stays online 24/7 with proper networking and security.

By following this guide, you will:

- Create a Hetzner Cloud account and project with proper firewall rules
- Provision a cost-optimized CX33 VPS running Ubuntu 24.04
...
## Step 1 – Set Up Your Hetzner Cloud Infrastructure

### Step 1.1 – Create a Hetzner Account and Project

First, you'll create a Hetzner Cloud account and organize your resources in a dedicated project.

1. Sign up at [Hetzner Cloud](https://accounts.hetzner.com/signUp)
2. Complete identity verification and add your payment method
3. Log into the [Hetzner Cloud Console](https://console.hetzner.com/projects)
4. Click **Create Project** and name it something descriptive like "CS2-Servers"

Your account is now ready. The console is where you'll manage all your cloud resources.

### Step 1.2 – Configure a Cloud Firewall
...
### Step 1.3 – Create Your Virtual Private Server

Now you'll provision the actual server that will host CS2.

1. Go to **Servers** and click **Add Server**
2. Configure these settings:
   - **Server Type:** CX33 (Cost-optimized, sufficient for 10–32 players)
   - **Location:** Choose the region closest to your players
   - **Operating System:** Ubuntu 24.04
   - **Firewall:** Select the firewall you created above
   - **Server Name:** "cs2-server" or descriptive name

3. Click **Create & Buy now**

Within seconds, your server will be created. Check your email for the server's IP address and root password.

> **VPS Note:** We need at least 4 vCPU cores, 8GB RAM and 80GB disk space. If your region doesn't have CX33, choose the next closest plan with similar specs
...
SSH allows you to remotely control your server. Replace `YOUR_SERVER_IP` with your actual server IP from your email.

```bash
ssh root@YOUR_SERVER_IP
```

When prompted, paste the root password from your Hetzner email. (The password won't display as you type—this is normal for security.)
...
In CS2, open the console (default: `~` key) and connect to your server:
...
You now have a fully operational CS2 dedicated server running 24/7 on Hetzner Cloud. Your server is:
