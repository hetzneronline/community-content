...
Note:  It's better to change port because OpenVPN port 1194 could be blocked, further port 443 is ideal for avoiding censorship because OpenVPN traffic looks identical to the regular ssl traffic.
...
<details>
    <summary>Show server.conf file</summary>
