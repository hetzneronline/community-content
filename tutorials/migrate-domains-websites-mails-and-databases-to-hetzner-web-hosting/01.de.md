...
tags: ["Domain Transfer", "Zone File", "Migration", "Wechsel", "Umstellung", "Auth Code", "Webspace", "FTP", "IMAP", "Sync", "Thunderbird", "FileZilla", "Export", "Import", "MySQL", "MariaDB", "PostgreSQL", "phpMyAdmin", "phpPgAdmin", "mysqldump", "pg_dump", "pg_restore"]
...
### Schritt 3.1 - Hinzufügen des neuen E-Mail-Kontos
...
### Schritt 3.2 - Verbinden Sie Ihren Mail-Client mit beiden Konten
...
### Schritt 3.2 - Hochladen aller Mails auf den neuen Mailserver
...
Signed-off-by: [Martin Badstübner martin@badstuebner.biz]
