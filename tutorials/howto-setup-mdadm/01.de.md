...
```
>
>**Hinweis**: Sollte das System auf dem RAID selbst liegen, is es notwendig. Den Bootloader auf der entsprechenden Festplatte zu installieren. Dies geschieht mit dem folgenden Befehl:
>```bash
