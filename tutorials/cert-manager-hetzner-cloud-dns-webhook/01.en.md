...
* [Helm](https://helm.sh/docs/intro/install/) v3.16 or later (specifically we need the `toYamlPretty` attribute support)
* A Hetzner Console account with DNS zones managed in the [Hetzner Console](https://console.hetzner.com/)
