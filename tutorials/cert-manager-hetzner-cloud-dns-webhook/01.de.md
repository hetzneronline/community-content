...
Der Webhook erweitert cert-manager, um DNS-01-Herausforderungen mithilfe der Hetzner Cloud DNS-API zu lösen. Du kannst ihn aus dem offiziellen Helm-Repository oder direkt aus dem Git-Repository installieren.
...
Eine E-Mail-Adresse ist nicht mehr nötig, weil Let's Encrypt Benachrichtigungen eingestellt hat.
...
Ein erfolgreich ausgestelltes Zertifikat zeigt "Ready: True" an:
