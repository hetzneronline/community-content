...
Here u just need to change servername.fqdn.tld to your servers fully qualified hostname, and the daemon will done the rest.

Then we restart the SSH service and the new hostname is set:
