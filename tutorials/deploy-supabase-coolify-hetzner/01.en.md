...
path: "/tutorials/deploy-supabase-coolify-hetzner"
...
| Type       | CX22 or higher (2 vCPU, 4GB RAM minimum)       |
| Networking | Public IPv4 ✅, IPv6 optional                  |
...
> **Note**: Remove any existing HTTP challenge commands if present. DNS challenge is required for wildcard certificates.
...
5432/tcp                   ALLOW IN    Anywhere                   # PostgreSQL Direct
6543/tcp                   ALLOW IN    Anywhere                   # PostgreSQL Pooler
```
...
4. **Backups**: Configure automated PostgreSQL backups
