...
date: "2019-05-27"
title: "How to Install Matomo Analytics on CentOS 7"
...
To run Matomo on your server, you needs:
...
According to the [Matomo Requirements](https://matomo.org/docs/requirements/) using of PHP 7.x, MariaDB, PHP Extension such as "PHP GD Extension" is recommended.


## Step 1 - Installing LEMP Stack

As mention in the requirements section of the tutorial, a LEMP stack (Linux, Nginx, MySQL/MariaDB and PHP) is required to run Matomo on the server. We will start with installing Nginx web server:
...
Install PHP and required PHP extensions using following command:
...
This installation is using MariaDB as the backend of Matomo, So we need to create MySQL database and User for Matomo installation.
...
This is the welcome screen of Matomo web installer. Go forward by click on **Next** button.

![Welcome Screen](matomo-1.png)

### Matomo System Check

Check if your system has all required packages, if everything is ok click **Next**.

![Matomo System Check](matomo-2.png)

### Matomo Database Setup

Enter your database information and click **Next**.

![Matomo Database Setup](matomo-3.png)

### Creating the Tables

After import database, click **Next**.

![Creating the Tables](matomo-4.png)

### Super User

Enter your Username, Password and Email to login web interface. Go forward by click on **Next** button.

![Super User](matomo-5.png)

### Setup a Website

Set your website, time zone in this step and click **Next**.

![Setup a Website](matomo-6.png)

### Javascript Tracking code

Get javascript tracking code for your website here and click on **Next** button.

![Javascript Tracking Code](matomo-7.png)

### Congratulation

Your matomo installation is complete. Click **Next** to go to login page.

![Congratulation](matomo-8.png)

### Sign in

Enter your username and password (Set in "Super User" step) and click on **SIGN IN** to login the admin web interface.

![Sign in](matomo-9.png)

After successful login, You will get Matomo dashboard like below.

![Matomo Dashboard](matomo-10.png)

## Conclusion

That's it, now you should have successfully installed Matomo on your CentOS 7 server.

You should now check the [Matomo Documentation](https://matomo.org/docs/) and learn more about how to use Matomo.
