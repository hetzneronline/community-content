...
- 3+ WordPress sites running on a single €4.35/month Hetzner Cloud server (CX22)
...
For this tutorial, we'll use CX22 which is perfect for getting started.
...
| Image | Ubuntu 24.04 |
| Type | CX22 (or higher based on site count) |
...
| This setup (Hetzner CX22) | €4.35/month total | €52.20 (~$57) |
