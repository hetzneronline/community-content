...
> When you create a new Hetzner Cloud Server, you can select the [Hetzner Cloud App Docker](https://docs.hetzner.com/de/cloud/apps/list/docker-ce) and `docker-ce` will automatically be preinstalled on the server.
...
- [Option 1 - Installing `docker.io`](#option-1---dockerio-installieren) - For a quick start

  Steps:

  * Install Docker

- [Option 2 - Installing `docker-ce`](#option-2---docker-ce-installieren)
