...
For Borg to be enabled on your Storage Box, you must first enable the service on the Robot webinterface. To do this, go to the settings page of your Storage Box in Robot and click on activate in "[SSH support](https://docs.hetzner.com/storage/storage-box/access/access-ssh-rsync-borg)".
