...
Damit Borg auf Ihrer Storage Box aktiviert ist, müssen Sie den Dienst zuerst im Robot aktivieren. Gehen Sie dazu im Robot auf die Einstellungsseite Ihrer Storage Box und klicken bei "[SSH-Support](https://docs.hetzner.com/de/robot/storage-box/access/access-ssh-rsync-borg)" auf aktivieren.

Falls SSH auf der Storage Box nicht verfügbar ist, müssen sie beispielsweise [SFTP](https://docs.hetzner.com/de/robot/storage-box/access/access-sftp-scp) für diesen Schritt verwenden.
