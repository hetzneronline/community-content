...
- Follow [this](https://www.collaboraoffice.com/code/linux-packages/) to install the required packages.
...
<alias_groups desc="default mode is 'first' it allows only the first host when groups are not defined. set mode to 'groups' and define group to allow multiple host and its aliases" mode="group">
            ...
            <group>
                    <host desc="hostname to allow or deny." allow="true">scheme://nextcloud.example.com</host>
            </group>
```
