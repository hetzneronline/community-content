...
## Step 4 - Install Let's Encrypt Certbot via Snap
...
Note: Store the paths to the SSL cert and key file as you need they in step 8.
...
## Step 9 - Activate Collabora Online App in Nextcloud
...
## Step 11 - Renew SSL Cert (Optional)

Let's Encrypt certs are only valid for a few months and then must be renewed. You can do this with the following commands:
...
After that your Nginx should use the fresh created SSL certs and is ready to go for a few months.
